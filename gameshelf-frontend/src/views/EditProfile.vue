            ...
            <div class="max-w-4xl mx-auto px-6">
                <div class="flex items-end -mt-12 gap-6 pb-6">
                    <div class="relative group cursor-pointer">
                        <div class="w-28 h-28 md:w-32 md:h-32 rounded-2xl bg-gsoscuro border-4 border-gsoscuro overflow-hidden shadow-xl">
                            <img :src="avatarPreview || profile?.avatar" class="w-full h-full object-cover opacity-60" />
                            <div class="absolute inset-0 flex items-center justify-center bg-gsoscuro/40 group-hover:bg-gsoscuro/60 transition-all rounded-2xl">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-gsmenta" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" />
                                </svg>
                            </div>
                        </div>
                        <input type="file" @change="handleAvatarChange" class="absolute inset-0 opacity-0 cursor-pointer" ref="fileInputRef" accept="image/*" />
                    </div>
                    <div class="mb-2">
            ...
            <form @submit.prevent="saveProfile" class="space-y-8">
                ...
                <section class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="col-span-full">
                        <h3 class="text-xs uppercase tracking-[0.2em] text-gsmenta font-bold mb-4">Información Personal</h3>
                    </div>
...
function handleAvatarChange(event: Event) {
    ...
    if (file) {
        ...
        // Aquí podrías preparar el archivo para subirlo al backend
    }
}
