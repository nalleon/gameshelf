...
public interface IGameCollectionItemRepository {
    ...
    List<GameCollectionItem> findAllInCollectionWithFilters(Collection collection, Region region, Platform platform,
                                                      Format format, Edition edition);
    boolean delete(Integer id);
    GameCollectionItem update(GameCollectionItem gameCollectionItem);
}
