...
public interface IWishListItemService {
    WishListItem add(int priority, String annotation, Format format, Platform platform, Edition edition, Region region,
                     Game game, User user);
    ...
    List<WishListItem> findAllByUserWithFilters(User user, Region region, Platform platform, Format format, Edition edition, Integer priority);
    boolean delete(Integer id);
    WishListItem update(Integer id, int priority, String annotation,
                        Format format, Platform platform, Edition edition, Region region,
                        Game game, User user);
    WishListItem updatePriority(Integer id, int priority);
    WishListItem updateAnnotation(Integer id, String annotation);
}
