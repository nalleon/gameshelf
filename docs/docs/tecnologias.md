...
Estas son las tecnologías que se han utilizado para el desarrollo de GameShelf:

- :lucide-file-text: **Documentación:**
...
- :lucide-flask-conical: **Testing**
    ...
    - [Pytest - Cov](https://pypi.org/project/pytest-cov/) añade la funcionalidad del porcentaje de codigo testeado
    - [Pytest - Rich](https://pypi.org/project/pytest-rich/) hace que al lanzar los test, se devuelva información más específica sobre estos

- :lucide-code: **Frameworks:**
